    ...
    return (
      <View style={{ flex: 1, marginLeft: Metrics.doubleBaseMargin, marginRight: Metrics.doubleBaseMargin, marginTop: Metrics.baseMargin, marginBottom: Metrics.baseMargin }}>
        <View style={{ flex: 1, alignItems: 'flex-start' }}>
          <Text style={{ fontSize: scaleByVertical(22), color: 'rgba(0,0,0,0.7)' }}>Download Series</Text>
          <Text style={{ fontSize: scaleByVertical(17), color: '#212121', marginTop: Metrics.smallMargin }}>Welcome to ReadAskChat. Download all available content?</Text>
