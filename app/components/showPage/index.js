...
import { Image, TouchableOpacity, Text, PanResponder } from 'react-native';
...
class ShowPage extends Component {
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        ...
        if (Math.abs(gestureState.dx) <= 30) {
          ...
          const forward = () => {
            return this.customSwiper.currentIndex() < this.customSwiper.total() - 1 ? this.customSwiper.scrollBy(1) : null;
          };
          const backward = () => {
            return this.customSwiper.currentIndex() > 0 ? this.customSwiper.scrollBy(-1) : null;
          };
  ...
  render() {
    ...
    const lists = this.state.books.map(item => {
      return (
        ...
        {this.renderPlayer()}
        {
          ...
          >
            <CustomSwiper
              ...
              width={scale(210)}
              height={scaleByVertical(this.props.language.toLowerCase() === 'en' ? 94 : 104)}// (Metrics.screenWidth / 50) * (this.props.language.toLowerCase() === 'en' ? 7 : 8)}
        ...
        >
          <View style={{ padding: 20 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Metrics.baseMargin }}>
              <Radio
                selected={this.state.selectedBaby}
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Radio
                selected={this.state.selectedToddler}
                onPress={() => this.onCloseDialog1()}
              />
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Radio
                selected={this.state.selectedPreschooler}
                onPress={() => this.onCloseDialog1()}
              />
...
class ChooseDialog extends Component {
  ...
  render () {
    ...
    return (
        ...
        width={scale(340)}
        height={scaleByVertical(265)}
        onClosed={() =>{this.onClose(this.state.selectedOption)}}
        >
          <View style={{ flex:1, justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'row', paddingTop: scaleByVertical(10) }}>            
              <Text style={{ fontSize: scaleByVertical(17) }}>Choose Developmental Level</Text>            
          </View>
          <View style={{ flex:1, padding: scaleByVertical(Metrics.doubleBaseMargin), paddingTop: scaleByVertical(Metrics.baseMargin) }}>
            <Text style={{ fontSize: scaleByVertical(15) }}>
              ReadAskChat offers conversation starters at three age levels.
              Choose one now. You can change at any time.
            </Text>
          </View>
          <View style={{flex:3, justifyContent:'center', padding: scaleByVertical(Metrics.doubleBaseMargin)}}>
            <TouchableOpacity onPress={() => this.onSelected('baby')} style={{ flexDirection: 'row', alignItems: 'center', marginTop: scaleByVertical(5) }}>
              <Radio
                selected={this.state.selectedBaby} onPress={() => this.onSelected('baby')}
              />
              <View  style={{ flexDirection: 'row', alignItems: 'center' }}>
                <Text style={{ fontSize: Metrics.screenWidth / 45, color: Colors.babyColor, marginLeft: Metrics.baseMargin }}>
                  Baby
            ...
            <TouchableOpacity onPress={() => this.onSelected('toddler')} style={{ flexDirection: 'row', alignItems: 'center', marginTop: scaleByVertical(2) }}>
              <Radio
                selected={this.state.selectedToddler} onPress={() => this.onSelected('toddler')}
              />
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text style={{ fontSize: Metrics.screenWidth / 45, color: Colors.toddlerColor, marginLeft: Metrics.baseMargin }}>
                  Toddler
            ...
            <TouchableOpacity onPress={() => this.onSelected('preschooler')}  style={{ flexDirection: 'row', alignItems: 'center', marginTop: scaleByVertical(2) }}>
              <Radio
                selected={this.state.selectedPreschooler} onPress={() => this.onSelected('preschooler')}
              />
              <View style={{flexDirection: 'row', alignItems: 'center'}}>                
                <Text style={{ fontSize: Metrics.screenWidth / 45, color: Colors.preschoolerColor, marginLeft: Metrics.baseMargin }}>
                  Preschooler
          ...
          <View style={[styles.closeButton, {marginBottom: Metrics.doubleBaseMargin, marginRight: Metrics.doubleBaseMargin}]}>
            <Button
              style={[Styles.buttonRadius, { width: Metrics.screenWidth / 6, shadowOpacity: 0 }]}
