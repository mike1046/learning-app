...
class Api {
  ...
  register(email, password, orgcode = null) {
    return this.post(REGISTER_EMAIL, this.formData({ email, password, orgcode }));
  }
  ...
  changePassword({ email, password, newpassword }) {
    return this.post(RESET_PASSWORD, this.formData({ email, password, newpassword }));
  }
